        ...
        <div className="max-w-screen-xl mx-auto px-4 flex items-center h-20">
          <div>
            <div className="select-none flex items-center">
              <div className="mr-2">
                <img alt="Tailsc Logo" loading="lazy" width="50" height="50" decoding="async" data-nimg="1"
                     style={{ color:"transparent" }} src="/icon6.jpeg"
                />
                </div>
              <p className="text-2xl">MagicBox AI</p>
            </div>
          </div>
          ...
          {/*  <button className="text-center px-2 h-8 text-sm text-zinc-900 hover:text-blue-500 active:scale-95 transition-all">Sign in</button>*/}
