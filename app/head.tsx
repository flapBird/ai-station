      ...
      <header className="bg-white text-zinc-900">
        <div className="max-w-screen-xl mx-auto px-4 flex items-center h-16">
          ...
          <ul className="hidden md:flex flex-1 min-w-0 justify-center items-center gap-4">
            ...
            <li><a className="text-zinc-500 font-normal data-[active=true]:text-blue-500 hover:text-blue-500" href="#" data-active="true">Product</a></li>
            <li><a className="text-zinc-500 font-normal data-[active=true]:text-blue-500 hover:text-blue-500" href="#" data-active="false">Blog</a></li>
            <li><a className="text-zinc-500 font-normal data-[active=true]:text-blue-500 hover:text-blue-500" href="#" data-active="false">About</a></li>
            <li><a className="text-zinc-500 font-normal data-[active=true]:text-blue-500 hover:text-blue-500" href="#" data-active="false">Contact</a></li>
          </ul>
